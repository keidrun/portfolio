  ...
  return (
    <section id="work" className={workStyles.work}>
      <div className="container">
        ...
        <p className="lead">
          I’ve been designing and developing web applications and contributing in scrum teams, as professional since
          2011.
        </p>
          ...
          <div className="col-sm-12">
            <div className="card-group">
              <Card
                ...
                renderModal={() => (
                  <WorkDetailModal title="Full-stack Development">
                    <h6>
                      Web Front-End Replacement project with Spring MVC and MySQL for customers in customers in a
                      cellular company
                    </h6>
                    <ul>
                      <li>
                      ...
                      <li>
                        Arranged specifications of other existing back-end APIs and develop mock applications with
                        NodeJS for testing
                      </li>
                    </ul>
                    <h6>
                      Web Application Development with Spring MVC and PostgreSQL for customers in credit card company
                    </h6>
                    <ul>
                      <li>
                        The purpose of this project was to develop new featuers for existing web application along with
                        adding new business process to sell debit cards
                      </li>
                      <li>
                        Developed new features with Spring MVC and PostgreSQL to let the web application adapt the new
                        process
                      </li>
                    </ul>
                    <h6>
                    ...
                    <ul>
                      ...
                      <li>
                        Applied the framework to communicate with GCON that is an experimental sensor developed by
                        another team of customers in a convenience stores company
                      </li>
                    </ul>
                  </WorkDetailModal>
                )}
              ...
              <Card
                ...
                renderModal={() => (
                  <WorkDetailModal title="SaaS Development">
                    <h6>
                      Web Application Development with ASP.NET MVC and PostgreSQL for in-house product in a SaaS company
                    </h6>
                    <ul>
                      <li>
                        The purpose of this project was to develop new featuers for existing SaaS application in order
                        to respond quckly to rapid market change by COVID-19
                      </li>
                      <li>
                        Developed new features with ASP.NET MVC and PostgreSQL to let the web application adapt the new
                        business model
                      </li>
                    </ul>
                  </WorkDetailModal>
              ...
              >
                ...
                applications with Node.js and MongoDB for customers in a convenience stores company.
              </Card>
            </div>
            ...
            <div className="card-group">
                ...
                renderModal={() => (
                  <WorkDetailModal title="Scrum Coaching">
                    ...
                    <ul>
                      ...
                      <li>
                        Built new development teams to develop new web front-end and coached them in Scrum as Scrum
                        Master
                      </li>
                    </ul>
                  </WorkDetailModal>
              ...
              <Card
                ...
                renderModal={() => (
                  <WorkDetailModal title="Product Management">
                    ...
                    <ul>
                      <li>
                        The purpose of this project was to judge to establish a new department for Scrum by
                        demonstrating the effectiveness of Scrum Development with offshore teams
                      </li>
                      <li>
                ...
                renderModal={() => (
                  <WorkDetailModal title="Global Team Management">
                    ...
                    <ul>
                      ...
                      <li>
                        Managed an in-house team in Japan and an offshore team in China and developed a new web
                        front-end to distribute debit cards and control purchase of welfare-payment recipients in the
                        city
                      </li>
                    </ul>
              ...
              >
                Planed and managed global teams of developers in Japan and China to develop web applications for
                customers in financial companies and a Japanese government office.
              </Card>
            </div>
          </div>
        </div>
